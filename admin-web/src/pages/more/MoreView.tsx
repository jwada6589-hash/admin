...
import { Truck, Edit2, X, CheckCircle, Gift, Settings, Images, UserRoundX } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 pb-20 md:pb-6 animate-in fade-in duration-300">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-3xl p-5 shadow-sm border border-gray-100 flex flex-col justify-between h-full transition-all hover:shadow-md cursor-pointer" onClick={() => navigate('/more/account-deletions')}>
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="font-bold text-gray-900">طلبات حذف الحساب</h3>
              <p className="text-xs text-gray-500 mt-0.5 leading-relaxed">مراجعة طلبات المستخدمين والموافقة أو الرفض</p>
            </div>
          </div>
          <button className="w-full bg-white hover:bg-gray-50 text-gray-900 border border-gray-200 font-bold py-3 rounded-2xl transition-colors shadow-sm">فتح الطلبات</button>
        </div>
