...
import { Search, Plus, Edit2, Trash2, Tag, Calendar, AlertTriangle, X, Power, PowerOff } from 'lucide-react';
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-sm">
          <div className="bg-white rounded-3xl w-full max-w-sm shadow-xl p-6 text-center animate-in zoom-in-95 duration-200">
            ...
            <p className="text-gray-500 text-sm mb-6">
              ...
              <br />
              <span className="font-bold text-gray-700 mt-2 block">ملاحظة: هذا الإجراء لن يحذف المنتج الأصلي من النظام.</span>
            </p>
            <div className="flex gap-3">
              <button 
